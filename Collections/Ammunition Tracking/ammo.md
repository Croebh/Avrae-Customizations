Used for spending generic ammo when making attacks. Uses two Custom Counters, `Ammo` and `Used Ammo`, in order to track your current ammo count as well as how many you've used for the `!collect` alias.

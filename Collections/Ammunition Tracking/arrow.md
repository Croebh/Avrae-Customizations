Used for spending arrows when making attacks. Uses two Custom Counters, `Arrows` and `Used Arrows`, in order to track your current ammo count as well as how many you've used for the `!collect` alias.
